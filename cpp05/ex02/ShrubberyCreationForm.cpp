...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/04 11:57:46 by pmitsuko          #+#    #+#             */
/*   Updated: 2023/02/04 13:00:55 by pmitsuko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::fstream		fs_out;
	const std::string	newFileName = this->getTarget() + "_shrubbery";
